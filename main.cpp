...
int main() {
  ...
  ofile << "Report for each of the stored states:\n";
  ofile << "  length  | center of mass x | center of mass v\n";
  ...
  ofile << "\nSummary:\n";
  ofile << "Average length: " << (sum_length / v_states.size()) << '\n';
}
